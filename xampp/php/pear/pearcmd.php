...
if ('C:\GitHub\xampp-naturepoints\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\GitHub\xampp-naturepoints\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
